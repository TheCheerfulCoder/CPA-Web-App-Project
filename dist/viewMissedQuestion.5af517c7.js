...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dashboard/viewMissedQuestion.js":[function(require,module,exports) {
...
var MAX_QUESTIONS = 1; // Initialize or fetch the "testScores" object that holds all test score data
...
getNewQuestion = function getNewQuestion() {
  ...
  var studyQuestionID = localStorage.getItem('studyQuestionID');
  var questionIndex = parseInt(studyQuestionID, 10);
...
choices.forEach(function (choice) {
  choice.parentElement.addEventListener('click', function (e) {
    ...
    console.dir(e.target.tagName); // Get the data for the selected answer
