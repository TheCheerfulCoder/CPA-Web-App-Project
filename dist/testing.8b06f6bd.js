  ...
  choice.parentElement.addEventListener('click', function (e) {
    ...
    if (questionCounter === MAX_QUESTIONS) {
      if (localStorage.getItem('testScores') !== null) {
        ...
        testScoresDeserialized['Quiz ' + currentTestNumber.toString()] = scoreList; //   STEP 4: Re-serialize the object and put it back into local storage
        ...
        testScores['Quiz 1'] = scoreList; // Add testScores to local storage
